...
const std::string AppName = "Fake3DRenderer";
HWND ghWnd;
HDC ghDC;
HGLRC ghRC;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
    ...
    wndclass.hIcon = LoadIcon(hInstance, AppName.c_str());
    wndclass.hCursor = LoadCursor(NULL, IDC_ARROW);
    wndclass.hbrBackground = (HBRUSH) (COLOR_WINDOW + 1);
    wndclass.lpszMenuName = AppName.c_str();
    ...
    /* Create the frame */
    ghWnd = CreateWindow (AppName.c_str(),
